...
// SQLite has no migrations project — create its schema directly (see DatabaseExtensions.EnsureSqliteSchemaCreated).
DatabaseExtensions.EnsureSqliteSchemaCreated(app.Services, app.Configuration);
