...
// SQLite has no migrations project — create its schema directly (see DatabaseSchemaBootstrap).
DatabaseSchemaBootstrap.EnsureSqliteSchemaCreated(app.Services, app.Configuration);
